...
color:black;
margin-top: 8px;
text-shadow: 0 0 3px #73d7ee, 0 0 5px #13257b;
}
.navbar
{
float:right;
...
<a href="checkhistory.jsp">Check History</a>
        ...
        <div class="bg">
            <img src="img/question.png" style=" right: 0px;
    position: absolute;
    bottom: 0px;height: 240px;
    width: 212px;
"><br>
...
%>    
    ...
    <footer><center>
        <p>&copy 2021. Made by <b>Geetika Singh Rathore</b> <br> The Sparks Foundation</p>
</center>
</footer></body> </html>